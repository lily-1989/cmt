...
<%     
  ...
  //String market = user.getMarket();
    ...
    session.setAttribute("insertTable", "feedeng.abbrev");
%>
      ...
      <tr>
        ...
        <td width="100%">
          <table cellpadding="4" cellspacing="0" border="0" bgcolor="#cccccc">
            <tr><br>
              <td><font class="page-header">Add Text Replacement</font></td>
            </tr>
          </table>
        </td>
      </tr>
	...
	<table width="100%">
	  <tr>
	     <th align="left" colspan="2" class="td-title-bg"><span class="table-header">Fields</span></th>
          ...
          <tr class="td-on">
             <td align="left" width="20%"><span class="table-text">Applies to:</span></td>
	     <td align = "left">
	       <select name="field">
	       <option value="">ALL</option>
	       <option value="make">Make</option>
	       <option value="model">Model</option>
	       <option value="colorexterior">Color (Exterior)</option>
	       </select>
	     </td>
          </tr>
          <tr class="td-off">
             <td align="left"><span class="table-text">Search Text:</span></td>
	     <td align = "left"><input type="text" name = "origstring" size="40"/></td>
          </tr>
          <tr class="td-on">
             <td align="left"><span class="table-text">Replace Text:</span></td>
	     <td align = "left"><input type="text" name = "abbrev" size="40"/></td>
          </tr> 
          <tr>
             <td>&nbsp;</td>
