...
%>
    ...
    <tr>
      ...
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Bedrooms:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "3" name = "bedrooms" maxlength = "3" value = "<%= ad.getBedrooms() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Baths:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "4" name = "baths" maxlength = "4" value = "<%= ad.getBaths() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Price:</th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "20" name = "price" maxlength = "20" value = "<%= ad.getPrice() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com/Compressor - Optional)</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "8" name = "squareFeet" maxlength = "8" value = "<%= ad.getSquareFeet() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "60" name = "neighborhood" maxlength = "100" value = "<%= ad.getNeighborhood() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Property Address:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "60" name = "propertyAddress" maxlength = "200" value = "<%= ad.getPropertyAddress() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com/Compressor - Optional)</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <br><span class="edit-helptext">(FSBO.com/Compressor - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Country:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "50" name = "country" maxlength = "50" value = "<%= ad.getCountry() %>"/></span>
      <br><span class="edit-helptext">(FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th colspan="2">&nbsp;</th>
    ...
    <tr>
      ...
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "10" name = "openHouseStartTime1" maxlength = "10" value = "<%= ad.getOpenHouseStartTime1() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "airCondition" maxlength = "2" value = "<%= ad.getAirCondition() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Basement:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "basement" maxlength = "2" value = "<%= ad.getBasement() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Dishwasher:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "dishwasher" maxlength = "2" value = "<%= ad.getDishwasher() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Elevator:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "elevator" maxlength = "2" value = "<%= ad.getElevator() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Fireplace:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "fireplace" maxlength = "2" value = "<%= ad.getFireplace() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Fitness Room:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "fitnessRoom" maxlength = "2" value = "<%= ad.getFitnessRoom() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Dining Room:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "diningRoom" maxlength = "2" value = "<%= ad.getDiningRoom() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Family Room:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "familyRoom" maxlength = "2" value = "<%= ad.getFamilyRoom() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Laundry:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "laundry" maxlength = "2" value = "<%= ad.getLaundry() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Other Parking:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "otherParking" maxlength = "2" value = "<%= ad.getOtherParking() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Garage Parking:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "garageParking" maxlength = "2" value = "<%= ad.getGarageParking() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Pets:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "pets" maxlength = "2" value = "<%= ad.getPets() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg1" align = "left" valign="top"><span class="edit-label">Pool:</span></th>
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "2" name = "pool" maxlength = "2" value = "<%= ad.getPool() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com/FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
      <th class="edit-bg2" align = "left" valign="top"><span class="edit-label">Security:</span></th>
      <td class="edit-bg2"><span class="edit-text"><input type = "text" size = "2" name = "security" maxlength = "2" value = "<%= ad.getSecurity() %>"/></span>
      <br><span class="edit-helptext">(FSBO.com - Optional)</span>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="edit-bg1"><span class="edit-text"><input type = "text" size = "60" name = "agentUrl" maxlength = "100" value = "<%= ad.getAgentUrl() %>"/></span>
      <br><span class="edit-helptext">(Homescape.com - Optional)</span>
      </td>
    </tr>
    <tr>
