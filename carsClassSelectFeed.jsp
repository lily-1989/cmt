...
<form action="carsClassSearch.jsp">
...
if (feedcount == 1)
  response.sendRedirect("carsClassSearch.jsp?feedid="+lastValidFeedid+"&searchkey=&index=0");
...
<tr>
  <td><span class="table-text">Optional model search text:</span></td>
