...
<form action="carsReplaceSearch.jsp">
...
if (feedcount == 1)
  response.sendRedirect("carsReplaceSearch.jsp?feedid="+lastValidFeedid+"&searchkey=&index=0");
...
<tr>
  <td><span class="table-text">Optional filter by search text:</span></td>
